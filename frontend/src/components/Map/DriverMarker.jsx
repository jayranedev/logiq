...
import { DRIVER_MARKER_COLORS } from "../../utils/constants";
  ...
  return (
    <>
      ...
      {isSelected && (
        ...
        >
          <div style={{ minWidth: 140, padding: 8 }}>
            ...
            <div style={{
              ...
              borderRadius: 9999,
              background: status === "available" ? "rgba(16,185,129,0.2)" : status === "busy" ? "rgba(245,158,11,0.2)" : "rgba(100,116,139,0.2)",
              color: status === "available" ? "#34d399" : status === "busy" ? "#fbbf24" : "#94a3b8",
